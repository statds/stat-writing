...
+ No starting a sentence with a math symbol; rephrase to avoid it.
...
A reference is cited in the manuscript through their keys by `\citep{}` for
parenthetical citations or `\citet{}` for textual citations.  Variations
...
For `\citep{}`, multiple keys can be put in the same parentheses for citing
