...
+ Research question(s): Formulate a research question or hypothesis in the
...
+ Data description: Describe your data set (for instance: sampling scheme,
  ...
  yourself.
+ Plan of action: Describe briefly (5-7 lines) your plan of action. If you
...
+ Intuitions, expectations, and backup plan. What do you expect to find and why
  do you feel so? What if the investigation is not what you expect?
