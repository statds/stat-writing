...
1. Find a topic of interest. The topic should interest you, and be something 
   ...
   doable. You can get ideas for research by 
	...
	[American Statistician](https://www.tandfonline.com/journals/utas20)),
     books, magazines (e.g., [Chance](https://www.tandfonline.com/journals/ucha20); [Significance](https://academic.oup.com/jrssig)), and newspapers;
    + consulting;
    + collaboration.
  
   A critical factor to consider when identifying a topic is data. 
    + Idea-driven approach: You
    could start from an idea and then check if there are data available
    that can be used to test out your idea. It could be frustrating
     when you cannot find data after searching around.
    + data-driven approach: You could
    start from some available data and formulate your ideas by closely
    studying the data. This approach needs creative thinking to do
    something new on a old data.
